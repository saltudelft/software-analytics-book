...
In this paper we will first elaborate on the research protocol that was used in order to find 
papers
and extract information for the survey. Second, the actual findings for each of the research
questions will be explained.

## Research protocol
For this paper, Kitchenham's survey method \cite{Kitchenham2004} was applied. For this method, a protocol has to be
...
The keywords used to find papers were: software, test*, analytics, test-suite, evolution, software 
...
|---------------------|------------------|-----------------------------------------------------------|----|
|Test evolution       |@supportingtestsuite  | Google Scholar query: test-suite evolution | RQ2, RQ3 |
|Test evolution       |@pinto2013 | Referenced by: Understanding myths and realities of test-suite evolution | RQ1  |
|Test evolution       |@bevan2005 | Referenced by: Understanding myths and realities of test-suite evolution | Discarded |
|Test evolution       | @pinto2012understanding | Initial Paper Seed | RQ1  |
|Co-evolution         | @marsavina2014 | Google Scholar keywords: Maintain developer tests, in ‘cited by’ of “Aiding Software Developers to Maintain Developer Tests” on IEEE| RQ1 |
|Co-evolution         | @zaidman2011studying | Initial Paper Seed| RQ1  |
|Co-evolution         | @greiler2013 | In ‘cited by’ of “Understanding myths and realities of test-suite evolution” on Scopus | RQ2, RQ3 |
|Co-evolution         | @hurdugaci2012 | Keywords: Maintain developer tests, ‘cited by’ in “Studying the co-evolution of production and test code in open source and industrial developer test processes through repository mining” on IEEE | RQ2  |
|Production evolution | @eick2001 | Referenced by: Testing analytics on software variability | Discarded |
|Production evolution |@leung2015testing | Initial Paper Seed | RQ3 |
| Test generation     | @robinson2011 | Referenced in Supporting Test Suite Evolution through Test Case Adaptation | RQ2 |
|Test generation      | @bowring2014obsidian| Springer: Reverse search on “Automatically generating maintainable regression unit tests for programs” | RQ2, RQ3 |
|Test generation      | @shamshiri2018automatically | Google Scholar query: Automatically generating unit tests | RQ3 |
|Test generation      | @dulz2013model | Scopus query: “software development” AND Computer Science AND Software Engineering | RQ2 |
| Testing practices   | @GAROUSI20131354 | Google Scholar query: Survey software testing | RQ1  |
| Testing practices   | @beller2017developer | Initial Paper Seed | RQ1 |
| Testing practices   | @beller2015 | In ‘cited by’ of “Understanding myths and realities of test-suite evolution”. | RQ1 |
| Testing practices   | @moiz2017uncertainty | Springer query: software testing | RQ3 |
| Risk-driven testing | @hemmati2018 | In ‘cited by’ of “Test case analytics: Mining test case traces to improve risk-driven testing” | RQ3 |
| Risk-driven testing | @schneidewind2007 | Scopus query: risk-driven testing | RQ3 |
| Risk-driven testing | @vernotte2015 | Scopus query: “risk-driven” AND testing | RQ2, RQ3  |
| Risk-driven testing | @atifi2017 | In ‘cited by’ of “Risk-driven software testing and reliability” | RQ2, RQ3 |
| Risk-driven testing | @noor2015test | Initial Paper Seed | RQ2, RQ3 |

## Answers
In this section the research questions will be answered. To answer these questions, informtion from 
...
test cases. In Marsavina et al. @marsavina2014 it was observed that test cases were rarely
...
the purpose of validating new production code lines. It was observed by Pinto et al.
...
Different definitions for TDD were used across different documents. According to Zaidman et al.
...
However, it must be mentioned that the survey done by Garousi and Zhi @GAROUSI20131354 only
...
evolved. Dulz @dulz2013model found that by directed adjusting specific probability values in the
usage 
...
#### Risk-driven testing
The paper by Vernotte et al. @vernotte2015 introduces and reports on an original tooled risk-driven
security 
...
This section will elaborate on which furture developments can be expected in the field of software
analytics.
