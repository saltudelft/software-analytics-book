...
Although @pinto2012understanding found the investigation of automated test repairing is not a 
promising research avenue, as these techniques would require manual guidance which could end up 
being similar to traditional refactoring tools, more research is performed in this field since then. 
...
kill score, were readable by the product’s developers and required few edits as the system under test 
...
different user classes and test purposes in an automated approach. By using proper tools, like the 
their TestUS Testplayer, even less experienced test engineers will be able to efficiently generate 
