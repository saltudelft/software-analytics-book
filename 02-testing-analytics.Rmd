...
The table below describes for each paper, which search query resulted in which paper being found.
...
writing (e.g. Greiler et al. @greiler2013 in RQ2). The categorizations are based on the bullet
points extracted
