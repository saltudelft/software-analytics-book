...
languages. It notes that adoption of CI is often part of a reorganisation. It collected
...
that projects using CI release twice as oftern, accept pull requests faster and have developers
who are less worried about breaking the build.
