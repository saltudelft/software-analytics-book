...
```{r table-tools, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
require(pander)
...
```{r table-guidelines, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
require(pander)
panderOptions('table.split.table', Inf)
set.caption("Guidelines")
my.data <- " 
...
![Programming Languages Average Weighted EDP Ranking, retrieved from [ref:GKLS2018]](figures/EDPranking.jpeg)
