...
###Aswering SQ3
Dit stukje is mischien handig voor de papers over het meten van consumption?????
...
future research suggestions that are included. A similiarity between almost all of the papers discussed in this section is that they agree the research field is still not very mature. The conclusions of the majority of papers is that more research is required. However, in this survey we found that the consnesus was that it is hard to make strong claims, mainly due to having doubts about both the measurement methods as well as the research methodologies. 
