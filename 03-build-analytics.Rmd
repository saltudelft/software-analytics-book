...
contains amongst others, build logs from continuous integration such as Travis CI^[https://travis-ci.org/], 
Circle CI^[https://circleci.com/],Jenkins^[https://jenkins.io/], AppVeyor^[https://www.appveyor.com/] and 
TeamCity^[https://www.jetbrains.com/teamcity/] or surveys among developers about their usage of 
Continuous Integration or build systems. This information is often paired with data from 
 ...
 * (@zhao2017impact) How do teams change their pull request review practices in response to the
 introduction of continuous integration?
 * 

<!-- Research questions that emerge from the synthesis of the presented works -->

<!-- Below you can find the foundation laid in week 1 & 2, this is to be restructured into answers to research questions or additional information below research questions. -->
