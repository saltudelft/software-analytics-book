...
| Paper                   | Source              |  Reference                 |  RQ  | Obs.              |
| -----------------       | ----------------    |  ------------------------- | ---- | ------------------|                
| 1. Bird et al.          | Initial seed        | @bird2017predicting        |      |  US patent        |         
| 2. Beller et al.        | Initial seed        | @beller2017oops            | RQ3  |                   |                
| 3. Rausch et al.        | Initial seed        | @rausch2017empirical       |      |                   |
| 4. Beller et al.        | Initial seed        | @beller2017travistorrent   |      |                   |
| 5. Pinto et al.         | Initial seed        | @pinto2018work             | RQ3  |                   |
| 6. Zhao et al.          | Initial seed        | @zhao2017impact            | RQ3  | Collab China, Netherlands, USA Univ |
| 7. Widder et al.        | Initial seed        | @widder2018m               |      ||                   
| 8. Hilton et al.        | Initial seed        | @hilton2016usage           |      ||
| 9. Vassallo et al.      | Ref 2               | @vassallo2017tale          |      ||
| 11. Hassan et al.       | Ref 4               | @hassan2018hirebuild       |  RQ1 ||
| 12. Vassallo et al.     | Ref 2,3             | @vassallo2018break         |  RQ1, RQ3 ||   
| 13. Zampetti et al.     | Ref by 12           | @zampetti2017open          |      ||
| 14. Baltes et al.       | GScholar Search     | @baltes2018no              |  RQ1, RQ3 | Search term "Github Continuous Integration"|      
| 15. Bisong et al.       | GScholar Search     | @bisong2017built           |  RQ1, RQ3 ||
| 16. Santolucito et al.  | GScholar Search     | @santolucito2018statically |  RQ1 ||
| 17. Ni et al.           | GScholar Search     | @ni2018acona               |  RQ1 ||
...
The papers identified using the research protocol defined in the previous section that give as an
...
build working or build fixing purposes. Moreover, recent studies have focused on how satisfied are 
...
the frequency of integration and developer's productivity by proposing a machine learning models
...
![an image caption Source: Ultimate Funny Dog Videos Compilation 2013.](figures/Chapter3/state_pr.png)
