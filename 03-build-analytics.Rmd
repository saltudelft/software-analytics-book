...
10 Years Later" Award. The only paper that does not obey to this rule is the cornerstone description
...
being reference in the sections bellow. From the selected papers, we chose not to include in our
...
CI tools are, one particular paper by Widder et al. [@widder2018m] analyzing what factors have an impact 
