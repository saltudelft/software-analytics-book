...
revision control that ensures the management of changes to documents, source code and other
...
**Notes**
 ...
 that use Travis CI. Taking into account the small generalization degree of the findings highlighted by the
