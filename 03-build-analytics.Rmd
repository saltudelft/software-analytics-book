...
####Everyone can see what's happening
It should be easy to find out whether the build breaks and what/who made relevant changes. This ensures that 
communication trickels down to all programmers and that everyone can see what's happening. 
...
Baltes et al.[@baltes2018no] suggests that in future research more perspectives when analyzing commit data should
