...
Moreover, we used academical search engines like _GoogleScholar_ to perform a keyword based 
...
relevant papers that were published after 2008, in other words we not included papers older than
10 years. We have chosen 10 years as our threshold being inspired by "ICSE-Most Influential Paper
10 Years Later" Award. The only paper that does not obey to this rule is cornerstone description
of CI practices written by Martin Fowler, as we consider it important for us to see the practices
evolution in build analytics field. Most of the papers we found were linked to our research questions 
...
| ------------------------------------------------------------ 	| ------------------- | -------- | ----- |                
| 1. Bird and Zimmermann 2017 @bird2017predicting           	| Initial seed        | RQ1      | 1     |         
...
@bird2017predicting introduce a method for predicting software build errors. This US patent is owned
...
papers that addresses this matters is @bisong2017built. This paper aims to find a balance between
...
CI is widely used in practice nowadays. The paper by @rausch2017empirical explores how CI is widely available 
...
fundamental practices presented by @fowler2006continuous. The practices presented by @fowler2006continuous are 
...
The practice advocates the use of a revision control system for the project's source code. All artifacts required 
...
to find and remove. The above practices are important for the smooth functioning of CI framework.
