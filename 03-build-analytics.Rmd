...
Moreover, we used academical search engines like _Google_ _Scholar_ to perform a keyword based
...
The tools that are being proposed are:
  ...
  * HireBuild to automatically fix build failures based on previous changes [re@hassan2018hirebuild]
