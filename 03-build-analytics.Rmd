...
| 2. Beller et al.        | Initial seed        | @beller2017oops            |      |                   |                
| 3. Rausch et al.        | Initial seed        | @rausch2017empirical       |      |                   |
| 4. Beller et al.        | Initial seed        | @beller2017travistorrent   |      |                   |
| 5. Pinto et al.         | Initial seed        | @pinto2018work             |      |                   |
| 6. Zhao et al.          | Initial seed        | @zhao2017impact            |      | Collab China, Netherlands, USA Univ |
...
| 12. Vassallo et al.     | Ref 2,3             | @vassallo2018break         |  RQ1 ||   
| 13. Zampetti et al.     | Ref by 12           | @zampetti2017open          |      ||
| 14. Baltes et al.       | GScholar Search     | @baltes2018no              |  RQ1 | Search term "Github Continuous Integration"|      
| 15. Bisong et al.       | GScholar Search     | @bisong2017built           |  RQ1 ||
