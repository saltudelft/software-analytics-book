...
| -------------           | -------------       |  ------------------------- |
| 1. Bird et al.          | Initial seed        | @bird2017predicting        |                 
...
| 6. Zhao et al.          | Initial seed        | @zhao2017impact            |
...
| 11. Hassan et al.       | Ref 4               | @hassan2018hirebuild       |
| 12. Vassallo et al.     | Ref 2,3             | @vassallo2018break         | 
| 13. Zampetti et al.     | Ref by 12           | @zampetti2017open          |
| 14. Baltes et al.       | GScholar Search     | @baltes2018no              |
| 15. Bisong et al.       | GScholar Search     | @bisong2017built           |
| 16. Santolucito et al.  | GScholar Search     | @santolucito2018statically |
| 17. Ni et al.           | GScholar Search     | @ni2018acona               |
