...
| @rahman11         | is author of | @Rahman2013                              |
...
The retionale behind using code complexity as a metric for bug prediction is that
...
and measure class-related concepts like amount of methods, coupling, inheritance and cohesion
[@Gyimothy2005, @Radjenovic2013, @Malhotra2015, @Catal2009review].
...
This data can be obtained by building abstract syntax trees 
...
However, it turns out that developer experience has no clear correlation
...
The authors find that the most informative metrics are the number of low-degree-of-interest-file
...
They also show that using ASTs can imporove cross-project prediction results [@wang2016].
