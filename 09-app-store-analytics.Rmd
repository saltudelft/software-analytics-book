...
[@di2016would]** 
 ...
 - Relevance score: 10
 - Remarks: the authors applied classification and summarization techniques on app reviews in order
   to reduce the effort required to analyze feedback from users. As can be seen, the paper was
   focused in using the reviews to improve the development process.
...
negative user concerns were apps asking for too many permission or a bad timing asking for
permissions.
