...
[@mujahid2017examining] examines issues that bother the users of Android Ware, and the second one done by
...
reviews [^1],[^2]. In 2016 Google deployed their review analytics solution, called Review Highlights[^3],
...
AppBot[^5] or TheTool[^6] perform sentiment analysis on the
