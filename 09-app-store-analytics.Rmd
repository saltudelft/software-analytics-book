...
Challenges & Future Research:
* One of the open challenges is including indirect relationships in the comparisons as only direct relationships were used in work by Li et al.
* Hu et al. noticed that apps that have been developed using hybrid development tools had relatively low ratings. Future studies should be done to investigate the quality of hybrid apps and compare them with the quality of native apps.
* A detailed approach grouping topics with more granularity.
* Market-scale analysis using a large amount of apps and reviews.  
