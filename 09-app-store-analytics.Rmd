...
Right now developers can respond to 500 user reviews per day using the Google Play API, it is worth investigating whether a limit of 500 responses is sufficient to ban useless responses from the
