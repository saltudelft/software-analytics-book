...
As stated in the motivation, the survey by [KITCHENHAM ET HAL] gave us a starting point. Instead of gathering everything related to App Store Analytics we decided to focus on updating the work done by the the authors and using to answer the research questions specifically for the subcategory of Review Analytics. In this order of ideas, all the papers that [KITCHENHAM ET HAL] found related Review Analytics were retrieved and inspected to get a sense of their specific keywords and content. 
...
**What would users change in my app? summarizing app reviews for recommending software changes [@CITATION]** 
- Relevance score: 10
- Remarks: TODO

**Fault in your stars: an analysis of Android app reviews [@CITATION]** 
- Relevance score: 5
- Remarks: TODO

**Why are Android apps removed from Google Play?: a large-scale empirical study [@CITATION]** 
- Relevance score: 0
- Remarks: TODO
...
**Complete reference:** @li2017crowdsourced
...
Sannio, Italy - Sebastiano Panichella - University of Zurich, Switzerland - Carol V. Alexandru -
University of Zurich, Switzerland - Junji Shimagaki - Sony Mobile Communications, Japan - Corrado
A. Visaggio - University of Sannio, Italy - Gerardo Canfora - University of Sannio, Italy - Harald
C. Gall - University of Zurich, Switzerland
...
agenda of recommended software changes, which is actionable for developers. [Reference paper]
