...
In the year 2008, the first app stores became available[@appStoreLaunch][@androidMarketLaunch]. These marketplaces have grown rapidly in
...
engineering" [@martin2015survey]. In the paper, 7 main categories are proposed of the field: API Analysis, Review
...
Google Scholar[^9], ACM Digital Library[^10], and IEEE Xplore[^11] were used for the searching process with the
...
@i2017crowdsourced analyzed the use of crowdsourcing platforms such as Microworkers[^8] to manipulate
