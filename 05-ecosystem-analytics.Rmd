...
Developer tend to reacet poorly to changes in their dependencies; @Kula2017 has found that,
...
an empericaly study done by @McDonnell2013 on the android API, they also do not update their 
...
popular GitHub projects follow a higher order function.
...
Another interesting topic of research is the impact tools can have on eco-systems. Among these
tools are badges. Badges are annotations on software projects which display some information 
about a software project. One of these badges can warn developers about out-dated packages.
