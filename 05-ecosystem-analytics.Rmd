...
like Left-pad stress the possible impact trivial packages can have on a software ecosystem.
...
Developers take a very long time to adapt to these changes.
...
the way we can deal with breaking changes.
