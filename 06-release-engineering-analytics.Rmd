...
- **Continuous Deployment or Continuous Delivery (CD).**
    ...
    a software product to the end user automatically
    whenever new code is committed or merged.
...
Besides these six technical components,
...
- **RQ1:** _How is modern release engineering done in practice?_
    ...
    modern release engineering: Rapid Releases, Continuous Integration,
