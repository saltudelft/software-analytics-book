...
### RQ 1: Current Release Engineering Practices
...
- **Continuous Deployment or Continuous Delivery (CD).**
    ...
    These two terms describe the ability to deploy (or deliver)
    a software product to the end user very frequently.
    A term related to this is **Rapid Releases (RR)**.

Besides these two components, @adams2016a also identified three other concepts
...
Besides these five technical components,
...
### RQ 2: Studied Parts of Release Engineering
...
- **RQ 1:** _How is modern release engineering done in practice?_

    We found that there are five important technical aspects to
    modern release engineering: Continuous Integration, Continuous Deployment or
    Rapid Releases, Branching and Merging, Build Configuration and
    Infrastructure-as-code.
