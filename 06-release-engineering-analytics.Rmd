...
However, it will be useful verify these results given the fact that most of
...
(library) adoption @fujibayashi2017a and
...
rigour of empirical studies, and thus presents opportunities for software
analytics research.
...
- **RQ3:** _What aspects of modern release engineering make for relevant
  study objects in future software analytics research?_
    ...
    it may be beneficial triangulate results using various research methods.
