...
Similar conclusions based on Mozilla Firefox were made by @da2016a,
...
@laukkanen2018a have described what effects modern release engineering have on software with 
...
environments. More about the factors that can play a role is addressed by @rodriguez2017a, 
...
For example, @castelluccio2017a suggest exploring possibilities to leverage
...
- **RQ2:** _What aspects of modern release engineering have been studied
  in software analytics research so far?_
    ...
    organizational contexts. As all included studies suggest, more empirical studies are needed to be
