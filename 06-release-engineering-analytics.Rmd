...
@khomh2015a has looked into the effects of switching from traditional to rapid release cycles 
...
earlier in the software execution. @mantyla2015a has also considered data from Mozilla 
...
@castelluccio2017a has examined the practice of *patch lifting* in the release management at 
...
different organizational contexts. In this, this paper specifically focusses on continuous 
deployment (CD) practices. The paper has found that high internal quality standards combined 
with the large distributed organizational context of large corporations slowed the 
verification process down and therefore had a negative impact on release capability. While in 
small corporations, the lack of internal verification measures due to a lack of resources was 
mitigated by code review, disciplined CI and external verification by customers in customer 
environments. More about the factors that can play a role in @rodriguez2017a, where an 
overview of contributing factors in continuous deployment are defined and categorized based on 
literature between 2001 and 2014.
...
discussed in this section. This is why all the emperical studies in this survey have one major 
...
<!-- TODO -->
- RQ2: What aspects of modern release engineering have been studied in software analytics
 research so far?
