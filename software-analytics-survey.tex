...
\end{minipage} & \begin{minipage}[t]{0.16\columnwidth}\raggedright\strut
Zaidman et al.
{[}\protect\hyperlink{ref-zaidman2011studying}{190}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.50\columnwidth}\raggedright\strut
...
Risk-driven testing\strut
\end{minipage} & \begin{minipage}[t]{0.16\columnwidth}\raggedright\strut
Vernotte et al. {[}\protect\hyperlink{ref-vernotte2015}{183}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.50\columnwidth}\raggedright\strut
...
{[}\protect\hyperlink{ref-zaidman2011studying}{190}{]}, there was no
...
{[}\protect\hyperlink{ref-zaidman2011studying}{190}{]}. With a longer
...
{[}\protect\hyperlink{ref-zaidman2011studying}{190}{]}
...
{[}\protect\hyperlink{ref-zaidman2011studying}{190}{]}, evidence of TDD
...
{[}\protect\hyperlink{ref-vernotte2015}{183}{]} introduces and reports
...
\protect\hyperlink{ref-zaidman2011studying}{190}{]}. Additionally a tool
...
{[}\protect\hyperlink{ref-vernotte2015}{183}{]} or that can detect risks
...
al. {[}\protect\hyperlink{ref-zhao2017impact}{193}{]}, Widder et al.
{[}\protect\hyperlink{ref-widder2018m}{187}{]} and Hilton et al.
...
\item
  ...
  {[}\protect\hyperlink{ref-vassallo2017tale}{182}{]}
\item
...
\item
  ...
  reference {[}\protect\hyperlink{ref-widder2018m}{187}{]}
\item
  methods from helping the developer to fix bugs in references
  {[}\protect\hyperlink{ref-hassan2018hirebuild}{79}{]},
  {[}\protect\hyperlink{ref-vassallo2018break}{181}{]}
\item
...
\item
  ...
  browse error logs {[}\protect\hyperlink{ref-vassallo2018break}{181}{]}
\item
...
{[}\protect\hyperlink{ref-widder2018m}{187}{]} analyzed what factors
...
\item
  ...
  {[}\protect\hyperlink{ref-widder2018m}{187}{]}
\item
  Continuous integration in a social-coding world: Empirical evidence
  from GITHUB {[}\protect\hyperlink{ref-vasilescu2014continuous}{180}{]}
\end{itemize}
...
\item
  ...
  {[}\protect\hyperlink{ref-vasilescu2014continuous}{180}{]}
\end{itemize}
...
by Widder et al.{[}\protect\hyperlink{ref-widder2018m}{187}{]}, one of
...
{[}\protect\hyperlink{ref-vasilescu2014continuous}{180}{]} studies a
...
in Vasilescu {[}\protect\hyperlink{ref-vasilescu2014continuous}{180}{]}
...
\item
  ...
  {[}\protect\hyperlink{ref-zhao2017impact}{193}{]}
\item
...
\begin{minipage}[t]{0.48\columnwidth}\raggedright\strut
6. Zhao et al. 2017
{[}\protect\hyperlink{ref-zhao2017impact}{193}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright\strut
Initial seed\strut
\end{minipage} & \begin{minipage}[t]{0.14\columnwidth}\raggedright\strut
RQ3\strut
...
\begin{minipage}[t]{0.48\columnwidth}\raggedright\strut
7. Widder et al. 2018
{[}\protect\hyperlink{ref-widder2018m}{187}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright\strut
Initial seed\strut
\end{minipage} & \begin{minipage}[t]{0.14\columnwidth}\raggedright\strut
RQ1\strut
...
{[}\protect\hyperlink{ref-vassallo2017tale}{182}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright\strut
Ref 2\strut
\end{minipage} & \begin{minipage}[t]{0.14\columnwidth}\raggedright\strut
-\strut
...
{[}\protect\hyperlink{ref-vassallo2018break}{181}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright\strut
Ref 2,3\strut
\end{minipage} & \begin{minipage}[t]{0.14\columnwidth}\raggedright\strut
RQ1, RQ3\strut
...
{[}\protect\hyperlink{ref-zampetti2017open}{191}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright\strut
Ref by 12\strut
\end{minipage} & \begin{minipage}[t]{0.14\columnwidth}\raggedright\strut
-\strut
...
{[}\protect\hyperlink{ref-vasilescu2014continuous}{180}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.20\columnwidth}\raggedright\strut
GScholar Search\strut
\end{minipage} & \begin{minipage}[t]{0.14\columnwidth}\raggedright\strut
RQ2\strut
...
{[}\protect\hyperlink{ref-zimmermann2009}{194}{]}.
...
{[}\protect\hyperlink{ref-wang2016}{185}{]}.
...
parsing JSON) of these libraries, without having to develop this
functionality itself. Moreover, multiple languages, such as Python and
Rust, provide package managers (pip\footnote{\url{https://scholar.google.com/}}
and Cargo\footnote{\url{https://dl.acm.org/}} respectively) which can be
...
on the rise as well. On platforms such as GitHub\footnote{\url{https://ieeexplore.ieee.org/}},
...
projects. In this structure,the nodes are the projects and the edges
represent a dependency between two software projects. This structure is
known as a \emph{software ecosystem}. As stated by
{[}\protect\hyperlink{ref-Messerschmitt2003}{131}{]}, a \emph{software
...
given by {[}\protect\hyperlink{ref-Lungu2009}{115}{]}: ``A software
ecosystem is a collection of software projects which are developed and
co-evolve in the same environment.''
{[}\protect\hyperlink{ref-Mens2013}{130}{]} extends this definition,
``by explicitly considering the communities involved (e.g.~user and
developer communities) as being part of the software ecosystem.''
...
Although {[}\protect\hyperlink{ref-Stallman2002}{170}{]} disagrees with
the use of the term ecosystem, he does not necessarily disagree with the
definition of the term. The definition which will be used in this
chapter is the definition of
...
{[}\protect\hyperlink{ref-Kitchenham2004}{101}{]} is used. This method
...
+\strut
\end{minipage} & \begin{minipage}[t]{0.09\columnwidth}\raggedright\strut
{[}\protect\hyperlink{ref-Trockman2018}{179}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.34\columnwidth}\raggedright\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.05\columnwidth}\raggedright\strut
{[}\protect\hyperlink{ref-Rajlich2014}{156}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.31\columnwidth}\raggedright\strut
...
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.12\columnwidth}\raggedright\strut
{[}\protect\hyperlink{ref-Malloy2017}{118}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.31\columnwidth}\raggedright\strut
...
can be divided into two categories: quantitative and qualitative. The
first thing that is common in the studied papers is the combination of
...
as used by {[}\protect\hyperlink{ref-Abdalkareem2017}{3}{]},
{[}\protect\hyperlink{ref-Bogart2016}{31}{]},
{[}\protect\hyperlink{ref-Decan2017}{52}{]},
{[}\protect\hyperlink{ref-Kikas2017}{96}{]}, and
{[}\protect\hyperlink{ref-Decan2018}{53}{]}. There are a few reasons why
this is the most common used ecosystem throughout the papers. Firstly,
npm is the largest software registry, according to their
website\footnote{\url{https://www.macrumors.com/2016/10/10/apple-dash-developer-fraudulent-reviews/}}.
Moreover, npm is the package manager of JavaScript.
{[}\protect\hyperlink{ref-Kikas2017}{96}{]} explains that it is
...
project's dependency files. Of course, there are more ecosystems which
have the same properties, such as RubyGems (Ruby) and Crates.io
(Rust){[}\protect\hyperlink{ref-Kikas2017}{96}{]}.

However, these are not the only used ecosystems.
{[}\protect\hyperlink{ref-Decan2018}{53}{]} use the \emph{libraries.io}
dataset for its research, which includes seven different packaging
ecosystems: Cargo (rust), CPAN (Perl), CRAN (R), npm (JavaScript), NuGet
(.NET), Packagist (PHP) and RubyGems (Ruby). By doing this,
{[}\protect\hyperlink{ref-Decan2018}{53}{]} is the paper with the most
used ecosystems in one paper in the body of the studied papers.
...
well. {[}\protect\hyperlink{ref-Bavota2014}{16}{]} researches the Apache
Community and therefore uses a dataset corresponding to the full Java
subset of the Apache ecosystem.
{[}\protect\hyperlink{ref-Cox2015}{48}{]} instead uses the dataset of
the Apache Maven Project to validate his created metric.
{[}\protect\hyperlink{ref-Claes2015}{43}{]} researches package
incompatibilities and therefore uses a ten year period of the Debian
i386 testing and stable distributions.
...
of the state of the art as discussed in the previous section. Rather
than a theoretical standpoint, we look at a practical angle. The papers
discussed in this section are mostly case studies and we will summarize
their findings. A schematic overview of our findings can be found in the
table below.

From most papers we find that developers are slow when updating their
dependencies, or sometimes they do not even do it at all.
...
introduced when dependencies are updated. According to
{[}\protect\hyperlink{ref-Raemaekers2017}{153}{]} about 33\% of
releases, either minor or major, contain a breaking change that needs
looking into. Breaking changes could pose compiling errors, thereby
breaking the system that depends on it.

Developer tend to reacet poorly to changes in their dependencies;
{[}\protect\hyperlink{ref-Kula2017}{104}{]} has found that, of the 4600
surveyed projects, 81.5\% of the projects contain outdated dependencies
which can lead to security risks. Not only do developers not update
their dependencies, according to an empericaly study done by
...
{[}\protect\hyperlink{ref-Constantinou2017}{45}{]} has researched which
factors indicate that a developer is likely to abandon an ecosystem.
Their study, which analyzed Github issues and commits, has found that
developers are more likely to abandon a system when they 1) do not
communicate with their fellow developers, 2) do not participate often in
social or technical activities and 3) for an extended period of time do
not react or commit anymore. Another interesting characteristic about
ecosystem health, studied by
{[}\protect\hyperlink{ref-Kula2017-2}{103}{]}, is the way in which
projects age over time. Their study found that the usage over time of
81.7\% of 4,659 popular GitHub projects follow a higher order function.

{[}\protect\hyperlink{ref-Malloy2018}{117}{]} has studied the transition
from Python 2 to Python 3. Python 3 has been out since 2008, and the
final Python 2 release was in 2010. Both are (almost) 10 years ago. Even
though, during their study they have found that most Python developers
choose to maintain compatibility with both Python 2 and Python 3 by only
using a subset of the Python 3 language. By not using the newly
developed features they are severely limiting themselves in their
language capabilities.

Another interesting topic of research is the impact tools can have on
eco-systems. Among these tools are badges. Badges are annotations on
software projects which display some information about a software
project. One of these badges can warn developers about out-dated
packages. Based on the results of
{[}\protect\hyperlink{ref-Trockman2018}{179}{]}, badges can have a
...
many risks bound to this. {[}\protect\hyperlink{ref-Dietrich2014}{58}{]}
has also found that there are a lot of problems in the Java ecosystem,
and has posed a set of relatively minor changes to both development
tools and the Java language itself that could be very effective.
...
in the framework of other package-based software distributions. However,
even if multiple ecosystems are researched within one paper, it shows to
still not be enough to provide a generalization for each ecosystem.
...
any claims that their results can be generalised beyond the main package
managers for specific languages. This is because
{[}\protect\hyperlink{ref-Decan2018}{53}{]} do not expect similar
results for networks such as WordPress, as these packages tend to be
more high-level (e.g.~used by end users instead of reused by other
packages). This overall shows that there is a lot of space for future
research to be done in generalizing research beyond the already
researched ecosystems.

Another persistent open challenge is the ability to determine the health
of an ecosystem. Although {[}\protect\hyperlink{ref-Jansen2014}{88}{]}
have provided OSEHO, ``a framework that is used to establish the health
of an open source ecosystem'',
{[}\protect\hyperlink{ref-Jansen2014}{88}{]} note that ``there is
surprisingly little literature available about open source ecosystem
health''. {[}\protect\hyperlink{ref-Kikas2017}{96}{]} agree, stating
that a general goal is to provide analytics to maintainers about the
overall ecosystem trends.

This challenge is related to determining a systems health.
{[}\protect\hyperlink{ref-Kikas2017}{96}{]} state that ``a measure
quantifying dependency health in an ecosystem should be developed''.
Moreover, according to {[}\protect\hyperlink{ref-Jansen2014}{88}{]},
determining the health of a system from an ecosystem perspective is
required to determine which systems to use.
...
addressed. {[}\protect\hyperlink{ref-Kikas2017}{96}{]} agree that
another general goal is to provide maintainers with tools to manage
their dependencies.
...
defined. {[}\protect\hyperlink{ref-Bavota2014}{16}{]} state that their
observations could be a starting point to build recommenders for
supporting developers in complex dependency upgrade activity.
{[}\protect\hyperlink{ref-Cox2015}{48}{]} provide ``a metric to aid
stakeholders in deciding on whether the dependencies of a system should
be updated''. However, {[}\protect\hyperlink{ref-Cox2015}{48}{]} state
multiple refinements on this metric which could still be researched.
...
\protect\hyperlink{ref-thongtanunam2017review}{175},
\protect\hyperlink{ref-thongtanunam2015should}{177},
\protect\hyperlink{ref-zanjani2016automatically}{192}{]} and some
...
\protect\hyperlink{ref-mcintosh2014impact}{129},
\protect\hyperlink{ref-shimagaki2016study}{168},
\protect\hyperlink{ref-thongtanunam2014reda}{178}{]}. The quantitative
...
\protect\hyperlink{ref-gousios2014exploratory}{73},
\protect\hyperlink{ref-shimagaki2016study}{168},
\protect\hyperlink{ref-thongtanunam2017review}{175}--\protect\hyperlink{ref-thongtanunam2015should}{177},
\protect\hyperlink{ref-zanjani2016automatically}{192}{]}. This mostly
...
\protect\hyperlink{ref-thongtanunam2017review}{175}--\protect\hyperlink{ref-thongtanunam2015should}{177},
\protect\hyperlink{ref-yang2016mining}{189}{]}, Android
{[}\protect\hyperlink{ref-thongtanunam2017review}{175},
\protect\hyperlink{ref-thongtanunam2015should}{177},
\protect\hyperlink{ref-thongtanunam2014reda}{178},
\protect\hyperlink{ref-yang2016mining}{189},
\protect\hyperlink{ref-zanjani2016automatically}{192}{]}, OpenStack
{[}\protect\hyperlink{ref-thongtanunam2017review}{175}--\protect\hyperlink{ref-thongtanunam2015should}{177},
\protect\hyperlink{ref-yang2016mining}{189}{]}, LibreOffice
{[}\protect\hyperlink{ref-thongtanunam2015should}{177},
\protect\hyperlink{ref-yang2016mining}{189}{]}, Eclipse
{[}\protect\hyperlink{ref-yang2016mining}{189},
\protect\hyperlink{ref-zanjani2016automatically}{192}{]}. Apart from
...
{[}\protect\hyperlink{ref-zanjani2016automatically}{192}{]}. What is
...
{[}\protect\hyperlink{ref-yang2016mining}{189}{]} introduces a well
...
Thongtanunam et al.
{[}\protect\hyperlink{ref-thongtanunam2016revisiting}{176}{]} back up
...
Thongtanunam et al.
{[}\protect\hyperlink{ref-thongtanunam2017review}{175}{]} add to this
...
Thongtanunam et al.
{[}\protect\hyperlink{ref-thongtanunam2015should}{177}{]} add that not
...
{[}\protect\hyperlink{ref-thongtanunam2017review}{175}{]} also note that
...
Thongtanunam et al.
{[}\protect\hyperlink{ref-thongtanunam2017review}{175}{]} also found
...
Thongtanunam et al.
{[}\protect\hyperlink{ref-thongtanunam2016revisiting}{176}{]} add to
...
\emph{RevFinder}
{[}\protect\hyperlink{ref-thongtanunam2015should}{177}{]} and
\emph{cHRev}
{[}\protect\hyperlink{ref-zanjani2016automatically}{192}{]}. Both tools
...
{[}\protect\hyperlink{ref-thongtanunam2015should}{177}{]}, further
...
According to reference
{[}\protect\hyperlink{ref-thongtanunam2014reda}{178}{]}, the authors aim
...
Reference: {[}\protect\hyperlink{ref-thongtanunam2014reda}{178}{]}
...
Reference: {[}\protect\hyperlink{ref-thongtanunam2015should}{177}{]}
...
Reference: {[}\protect\hyperlink{ref-thongtanunam2016revisiting}{176}{]}
...
Reference: {[}\protect\hyperlink{ref-thongtanunam2017review}{175}{]}
...
Reference: {[}\protect\hyperlink{ref-yang2016mining}{189}{]}
...
Reference: {[}\protect\hyperlink{ref-zanjani2016automatically}{192}{]}
...
{[}\protect\hyperlink{ref-thongtanunam2015should}{177}{]}. It recommends
...
2014\strut
\end{minipage} & \begin{minipage}[t]{0.13\columnwidth}\raggedright\strut
{[}\protect\hyperlink{ref-thongtanunam2014reda}{178}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.06\columnwidth}\raggedright\strut
29-09-2018\strut
\end{minipage} & \begin{minipage}[t]{0.07\columnwidth}\raggedright\strut
8\strut
...
2015\strut
\end{minipage} & \begin{minipage}[t]{0.13\columnwidth}\raggedright\strut
{[}\protect\hyperlink{ref-thongtanunam2015should}{177}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.06\columnwidth}\raggedright\strut
29-09-2018\strut
\end{minipage} & \begin{minipage}[t]{0.07\columnwidth}\raggedright\strut
5\strut
...
2016\strut
\end{minipage} & \begin{minipage}[t]{0.13\columnwidth}\raggedright\strut
{[}\protect\hyperlink{ref-thongtanunam2016revisiting}{176}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.06\columnwidth}\raggedright\strut
29-09-2018\strut
\end{minipage} & \begin{minipage}[t]{0.07\columnwidth}\raggedright\strut
6\strut
...
2017\strut
\end{minipage} & \begin{minipage}[t]{0.13\columnwidth}\raggedright\strut
{[}\protect\hyperlink{ref-thongtanunam2017review}{175}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.06\columnwidth}\raggedright\strut
29-09-2018\strut
\end{minipage} & \begin{minipage}[t]{0.07\columnwidth}\raggedright\strut
10\strut
...
2016\strut
\end{minipage} & \begin{minipage}[t]{0.13\columnwidth}\raggedright\strut
{[}\protect\hyperlink{ref-yang2016mining}{189}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.06\columnwidth}\raggedright\strut
29-09-2018\strut
\end{minipage} & \begin{minipage}[t]{0.07\columnwidth}\raggedright\strut
12\strut
...
2016\strut
\end{minipage} & \begin{minipage}[t]{0.13\columnwidth}\raggedright\strut
{[}\protect\hyperlink{ref-zanjani2016automatically}{192}{]}\strut
\end{minipage} & \begin{minipage}[t]{0.06\columnwidth}\raggedright\strut
29-09-2018\strut
\end{minipage} & \begin{minipage}[t]{0.07\columnwidth}\raggedright\strut
7\strut
...
empirical study {[}\protect\hyperlink{ref-wang2018android}{184}{]}} -
...
{[}\protect\hyperlink{ref-xie2016you}{188}{]}. In the paper, Xie et al.,
...
suspicious {[}\protect\hyperlink{ref-xie2016you}{188}{]}. Regarding the
...
al. {[}\protect\hyperlink{ref-wei2017oasis}{186}{]} proposed a method,
...
{[}175{]} Thongtanunam, P. et al. 2017. Review participation in modern
code review. \emph{Empirical Software Engineering}. 22, 2 (2017),
768--817.

\hypertarget{ref-thongtanunam2016revisiting}{}
{[}176{]} Thongtanunam, P. et al. 2016. Revisiting code ownership and
...
{[}177{]} Thongtanunam, P. et al. 2015. Who should review my code? A
...
{[}178{]} Thongtanunam, P. et al. 2014. Reda: A web-based visualization
...
{[}179{]} Trockman, A. 2018. Adding sparkle to social coding.
...
{[}180{]} Vasilescu, B. et al. 2014. Continuous integration in a
social-coding world: Empirical evidence from github. \emph{Software
maintenance and evolution (icsme), 2014 ieee international conference
on} (2014), 401--405.

\hypertarget{ref-vassallo2018break}{}
{[}181{]} Vassallo, C. et al. 2018. Un-break my build: Assisting
developers with build repair hints. (2018).

\hypertarget{ref-vassallo2017tale}{}
{[}182{]} Vassallo, C. et al. 2017. A tale of ci build failures: An open
...
{[}183{]} Vernotte, A. et al. 2015. \emph{Risk-driven vulnerability
testing: Results from eHealth experiments using patterns and model-based
approach}.

\hypertarget{ref-wang2018android}{}
{[}184{]} Wang, H. et al. 2018. Why are android apps removed from google
...
{[}185{]} Wang, S. et al. 2016. Automatically learning semantic features
...
{[}186{]} Wei, L. et al. 2017. OASIS: Prioritizing static analysis
...
{[}187{]} Widder, D.G. et al. 2018. I'im leaving you, travis: A
continuous integration breakup story. (2018).

\hypertarget{ref-xie2016you}{}
{[}188{]} Xie, Z. et al. 2016. You can promote, but you can't hide:
...
{[}189{]} Yang, X. et al. 2016. Mining the modern code review
...
{[}190{]} Zaidman, A. et al. 2011. Studying the co-evolution of
...
{[}191{]} Zampetti, F. et al. 2017. How open source projects use static
...
{[}192{]} Zanjani, M.B. et al. 2016. Automatically recommending peer
...
{[}193{]} Zhao, Y. et al. 2017. The impact of continuous integration on
...
{[}194{]} Zimmermann, T. et al. 2009. Cross-project defect prediction: A
